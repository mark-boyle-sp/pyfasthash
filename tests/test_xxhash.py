...
def test_xx_128(hash_tester):
    hash_tester(hasher_type=pyhash.xx_128,
...
@pytest.mark.benchmark(group='hash64', disable_gc=True)
def test_xx_hash128_perf(benchmark, hash_bencher):
...
def test_xxh3_hash128_perf(benchmark, hash_bencher):
    hash_bencher(benchmark, pyhash.xxh3_128,
                 321635069348597727998765129269811424625)
